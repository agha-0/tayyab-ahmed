    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="message"
          name="message"
          placeholder="Tell me about the role, product, feature, or collaboration you have in mind."
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Attachments up to 5MB are supported and will be forwarded with your message.
        </p>
      </div>
